...
void Stage1Boss_Nutoral::Damage([[maybe_unused]]CG_Gorira* pGorira)
{
	pGorira->Damaged();
}
...
void Stage1Boss_Attack::Damage([[maybe_unused]]CG_Gorira* pGorira)
{
...
void Stage1Boss_Damage::Damage([[maybe_unused]]CG_Gorira* pGorira)
{
	pGorira->Damaged();
}
...
void Stage1Boss_Death::Damage([[maybe_unused]]CG_Gorira* pGorira)
{
