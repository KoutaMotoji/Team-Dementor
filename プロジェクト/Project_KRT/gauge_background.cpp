//=====================================================================================================================
//
//ゲージの背景の処理[gauge_background.cpp]
...
void GaugeBackground::Update()
{
	...
	D3DXVECTOR2 v2Size = this->m_pGauge->GetSize() + this->m_v2AddSize;   //サイズの取得
	pVtx[0].pos = { v3Pos.x - (v2Size.x * 0.5f), v3Pos.y - (v2Size.y * 0.5f), 0.0f };
	pVtx[1].pos = { v3Pos.x + (v2Size.x * 0.5f), v3Pos.y - (v2Size.y * 0.5f), 0.0f };
	pVtx[2].pos = { v3Pos.x - (v2Size.x * 0.5f), v3Pos.y + (v2Size.y * 0.5f), 0.0f };
	pVtx[3].pos = { v3Pos.x + (v2Size.x * 0.5f), v3Pos.y + (v2Size.y * 0.5f), 0.0f };
